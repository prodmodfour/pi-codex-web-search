...
Run the local quality gate before changing or releasing the package:
...
The gate runs shell syntax checks, secret and generated-file guardrails, TypeScript checks, tests, build checks, and package dry-run validation without requiring real Codex authentication.
